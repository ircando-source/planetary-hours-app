...
const PLANETS = {
  saturn: {
    ...
    color: '#4B0082',
    symbol: '♄',
    vibration: 'Disciplină și Structură',
    description: 'Timp pentru concentrare, stabilirea limitelor, lucru karmic, meditație și planificare pe termen lung. Ideal pentru angajamente serioase și disciplină spirituală.',
    keywords: ['Responsabilitate', 'Răbdare', 'Înțelepciune', 'Limite', 'Karma'],
  },
  jupiter: {
    name: 'Jupiter',
    color: '#1E3A5F',
    symbol: '♃',
    vibration: 'Expansiune și Abundență',
    description: 'Timp pentru creștere, oportunități, noroc și prosperitate. Ideal pentru afaceri, educație, călătorii și expansiune spirituală.',
    keywords: ['Noroc', 'Prosperitate', 'Creștere', 'Optimism', 'Înțelepciune'],
  },
  mars: {
    name: 'Marte',
    color: '#DC143C',
    symbol: '♂',
    vibration: 'Energie și Acțiune',
    description: 'Timp pentru curaj, activitate fizică, competiție și asertivitate. Ideal pentru începerea proiectelor, antrenamente și depășirea obstacolelor.',
    keywords: ['Curaj', 'Forță', 'Pasiune', 'Ambiție', 'Voință'],
  },
  sun: {
    name: 'Soare',
    color: '#FF8C00',
    symbol: '☉',
    vibration: 'Vitalitate și Succes',
    description: 'Timp pentru leadership, creativitate, exprimare personală și recunoaștere. Ideal pentru întâlniri importante, muncă creativă și putere personală.',
    keywords: ['Leadership', 'Creativitate', 'Bucurie', 'Încredere', 'Faimă'],
  },
  venus: {
    name: 'Venus',
    color: '#FFD700',
    symbol: '♀',
    vibration: 'Iubire și Armonie',
    description: 'Timp pentru relații, frumusețe, artă și plăcere. Ideal pentru romantism, socializare, activități artistice și îngrijire personală.',
    keywords: ['Iubire', 'Frumusețe', 'Plăcere', 'Artă', 'Armonie'],
  },
  mercury: {
    name: 'Mercur',
    color: '#8A2BE2',
    symbol: '☿',
    vibration: 'Comunicare și Intelect',
    description: 'Timp pentru gândire, scris, vorbit și învățat. Ideal pentru negocieri, studii, mesaje și activități intelectuale.',
    keywords: ['Comunicare', 'Învățare', 'Călătorii', 'Logică', 'Adaptabilitate'],
  },
  moon: {
    name: 'Luna',
    color: '#228B22',
    symbol: '☽',
    vibration: 'Intuiție și Emoție',
    description: 'Timp pentru introspecție, vise, lucru psihic și îngrijire. Ideal pentru vindecare emoțională, probleme familiale și conectare cu intuiția.',
    keywords: ['Intuiție', 'Vise', 'Emoții', 'Îngrijire', 'Cicluri'],
  },
};
